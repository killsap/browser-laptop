...
module.exports = function withDragSortDetach (WrappedComponent: React.ComponentType<any>, evaluateDraggingItemAndParentSize: EvaluateDraggingItemAndParentSizeFunction) {
  class WithDragSortDetach extends React.Component<Props> {

    static displayName = `WithDragSortDetach(${WrappedComponent.displayName || WrappedComponent.name || 'Component'})`
